...
vegetables_template = [
    lambda c: f'a photo of a {c}, a type of vegetable.',
]

kvasir_template = [
    lambda c: f'a medical endoscopic image showing {c}.',
]

intelimages_template = [
    lambda c: f'an aerial image of {c}.',
]

weather_template = [
    lambda c: f'a weather condition: {c}.',
]
...
beans_template = [
    lambda c: f'a photo of a {c}, a type of bean.',
]

landscape_template = [
    lambda c: f'a landscape scene featuring {c}.',
]
